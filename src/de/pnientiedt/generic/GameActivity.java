...
/**
 * The game activity implements the Activity Life Cycle of the game. A {@link GameListener} can be attached to the activity and will be called
...
public class GameActivity extends Activity implements GLSurfaceView.Renderer, OnTouchListener, SensorEventListener {
	...
	/**
	 * Called when the application is paused. We need to also pause the GLSurfaceView.
	 */
	@Override
	...
	/**
	 * Called when the application is resumed. We need to also resume the GLSurfaceView.
	 */
	@Override
