...
/**
 * A simple Mesh class that wraps OpenGL ES Vertex Arrays. Just instantiate it with the proper parameters then fill it with the color, texCoord,
 * normal and vertex method.
 * 
 * @author mzechner
 * 
 */
public final class Mesh {
	...
	/**
	 * Renders the mesh as the given type using as many vertices as have been defined by calling vertex().
	 * 
	 * @param type
	 *            the type
	 */
	...
	/**
	 * Defines the position of the current vertex. Before you call this you have to call any other method like color, normal and texCoord for the
	 * current vertex!
	 * 
	 * @param x
	 *            the x coordinate
